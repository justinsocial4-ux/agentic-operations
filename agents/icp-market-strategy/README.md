...
These agents help teams understand who they should sell to, which segments are
working, and how large the opportunity is.

| Agent | What it does |
|---|---|
| [Account Scoring Agent](revops-account-scoring/SKILL.md) | Applies a named customer policy to verified account evidence and withholds incomplete or unvalidated conclusions. |
