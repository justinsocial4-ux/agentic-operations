...
from price_evidence import BOUNDARY, render_review_output, review_price_evidence


def fixture():
    basis = {"basis_id":"basis-alpha","basis_version":"version-alpha","product_scope_id":"product-alpha","configuration_scope_id":"configuration-alpha","quantity":"10","unit":"seat","currency":"USD","price_kind":"list-price","billing_basis":"per-seat","billing_period":"month","contract_term":"term-alpha","region":"region-alpha","tax_basis":"tax-excluded","fee_basis":"fees-excluded","discount_basis":"discount-none"}
    return {
            "policy":{"policy_id":"policy-alpha","policy_version":"version-alpha","owner_id":"owner-alpha","human_reviewer_role_id":"reviewer-alpha","effective_at":"2026-07-01T00:00:00Z","expires_at":None,"cutoff_at":"2026-07-11T00:00:00Z","timezone":"America/Guayaquil","approved_purpose":"competitive_price_evidence_review","prohibited_uses":["price-recommendation","discount-recommendation","monitoring","alert","crm-write","customer-action","workforce-action"],"correction_path":"submit-correction-receipt","calculation_policy":{"percentage_scale":2,"rounding_mode":"half_even"},"source_bindings":[{"lane":"internal_offer","source_id":"source-internal","schema_version":"schema-internal","authorization_id":"authorization-internal","authorization_effective_at":"2026-07-01T00:00:00Z","authorization_expires_at":None},{"lane":"public_list","source_id":"source-public","schema_version":"schema-public","authorization_id":"authorization-public","authorization_effective_at":"2026-07-01T00:00:00Z","authorization_expires_at":None}],"comparison_bases":[basis]},
        "declaration":{"review_id":"review-alpha","declared_observation_count":2,"observation_ids":["observation-left","observation-right"]},
        "source_populations":[{"population_receipt_id":"population-left","lane":"internal_offer","source_id":"source-internal","schema_version":"schema-internal","authorization_id":"authorization-internal","complete":True,"observation_ids":["observation-left"],"captured_at":"2026-07-10T12:00:00Z"},{"population_receipt_id":"population-right","lane":"public_list","source_id":"source-public","schema_version":"schema-public","authorization_id":"authorization-public","complete":True,"observation_ids":["observation-right"],"captured_at":"2026-07-10T12:00:00Z"}],
        "observations":[{"observation_id":"observation-left","lane":"internal_offer","party_id":"party-internal","item_id":"item-internal","source_id":"source-internal","schema_version":"schema-internal","authorization_id":"authorization-internal","basis_id":"basis-alpha","basis_version":"version-alpha","amount":"120.00","effective_begin":"2026-07-01T00:00:00Z","effective_end":"2026-08-01T00:00:00Z","occurred_at":"2026-07-08T00:00:00Z","captured_at":"2026-07-09T00:00:00Z","population_receipt_id":"population-left"},{"observation_id":"observation-right","lane":"public_list","party_id":"party-competitor","item_id":"item-competitor","source_id":"source-public","schema_version":"schema-public","authorization_id":"authorization-public","basis_id":"basis-alpha","basis_version":"version-alpha","amount":"100","effective_begin":"2026-07-01T00:00:00Z","effective_end":"2026-08-01T00:00:00Z","occurred_at":"2026-07-07T00:00:00Z","captured_at":"2026-07-09T00:00:00Z","population_receipt_id":"population-right"}],
...
class PriceEvidenceTests(unittest.TestCase):
    def test_valid(self):
        result=review_price_evidence(fixture()); self.assertEqual(result["review_type"],"COMPETITIVE_PRICE_EVIDENCE_REVIEW"); self.assertEqual(result["comparison_receipts"][0]["state"],"COMPARABLE")
    ...
    def test_no_action_fields(self):
        ...
        for key in ('"recommendation":','"confidence":','"risk":','"rank":','"forecast":','"crm_write":','"coaching":'): self.assertNotIn(key,output)
